...
const ThemeButton = () => {
    ...
    return (
        <div className='size-8 rounded-md bg-purple-300 flex justify-center items-center'>
            <button class="flex items-center justify-center  relative" onClick={chnageTheme}>
                <div class={`${theme === "light" ? "block" : "hidden"}`}>
                ...
                <div class={`${theme === "dark" ? "block" : "hidden"}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="18" width="18">
