                ...
                {authUser ?
                    <div className='relative h-full' ref={menuRef}>
                        <button onClick={() => setIsMenu(true)}>
                            {authUser?.image ?
                                <img src={authUser?.image} alt="no image" className='rounded-md size-10 object-fit' />
                                :
                    ...
                    :
                    <Link to={'/login'} className='text-white px-4 py-1 text-lg font-semibold bg-purple-600 rounded-md active:scale-90'>Login</Link>
                }
