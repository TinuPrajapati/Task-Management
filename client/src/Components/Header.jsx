                ...
                <div className='relative h-full' ref={menuRef}>
                    ...
                    <div className={`absolute right-0 top-12 w-60 py-1 bg-white rounded-lg shadow-lg border-2 border-purple-400 ${isMenu ? "block" : "hidden"}`}>
                        ...
                        <div className='w-full px-2.5 flex flex-col gap-1'>
                            <Link
                                to="/profile" className='flex items-center h-10 gap-2 px-1 text-xl duration-500 hover:text-purple-400 hover:justify-center'><SquareUserRound /> Profile</Link>
                            <div className='flex items-center h-10 gap-2 px-1 text-xl duration-500 hover:text-purple-400 hover:justify-center'><LogOut />Logout</div>
                        </div>
                    </div>
                </div>
            </div>
